...
class CNN(nn.Module):
    ...
    def __init__(self, time_step):
        ...
        resnet18network.load_state_dict(torch.load('weights/resnet34-333f7ec4.pth'))
...
class IAMModel(nn.Module):
    ...
    def __init__(self, time_step, feature_size,
        ...
        self.scorer = Scorer(alphabet=self.alphabet, scorer_path='./scorers/iam_uncased.scorer', alpha=0.75, beta=1.85)
